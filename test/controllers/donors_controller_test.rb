...
class DonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post donors_url, params: { donor: { Blood_doneted_on: @donor.Blood_doneted_on, Bloodgroup: @donor.Bloodgroup, address: @donor.address, age: @donor.age, contact: @donor.contact, name: @donor.name } }
    end
  ...
  test "should update donor" do
    patch donor_url(@donor), params: { donor: { Blood_doneted_on: @donor.Blood_doneted_on, Bloodgroup: @donor.Bloodgroup, address: @donor.address, age: @donor.age, contact: @donor.contact, name: @donor.name } }
